...
func NewOrderService(
	createOrderUseCase usecase.CreateOrderUseCase, listOrderUsecase usecase.ListOrdersUseCase) *OrderService {
	return &OrderService{
...
func (s *OrderService) ListOrders(ctx context.Context, in *pb.Blank) (*pb.ListOrdersResponse, error) {
	output, err := s.CreateOrderUseCase.OrderRepository.FindAll()
	if err != nil {
		return nil, err
	}
